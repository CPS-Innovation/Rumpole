...
namespace RumpoleGateway.Tests.Clients.RumpolePipeline
{
	public class PipelineClientTests
	{
		...
		public PipelineClientTests()
		{
			...
			_mockRequestFactory.Setup(factory => factory.Create($"cases/{_caseId}", _accessToken)).Returns(_httpRequestMessage);
			_mockRequestFactory.Setup(factory => factory.Create($"cases/{_caseId}/tracker", _accessToken)).Returns(_httpRequestMessage);
			...
			TriggerCoordinatorPipelineClient = new PipelineClient(_mockRequestFactory.Object, _triggerCoordinatorHttpClient, _mockJsonConvertWrapper.Object, _mockLogger.Object);
			GetTrackerPipelineClient = new PipelineClient(_mockRequestFactory.Object, _getTrackerHttpClient, _mockJsonConvertWrapper.Object, _mockLogger.Object);
		}
